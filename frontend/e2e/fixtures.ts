...
/**
 * 폴리 게이트 둘과 금속 플러그 여섯. CMOS 처럼 같은 종류의 계면이 여럿일 때를
 * 본다 — 예전에는 둘 다 `gate` 로 이름 붙어 하나를 지우면 다른 하나까지
 * 사라졌다.
 *
 * 백엔드 픽스처 `backend/tests/fixtures/2d_two_gates.in` 과 같은 내용이다.
 */
export const TWO_GATE_SOURCE = String.raw`# 전극 이름 겹침 시험용 최소 구조.
# 폴리 게이트 둘과 금속 플러그 여섯(각 트랜지스터의 소스·게이트·드레인).
# CMOS 처럼 같은 종류의 계면이 여럿일 때 이름이 겹치지 않는지 본다.

line x loc=0.0 spacing=0.25 tag=left
line x loc=4.0 spacing=0.25 tag=right
line y loc=0.0 spacing=0.05 tag=top
line y loc=0.4 spacing=0.2
line y loc=1.5 spacing=0.5 tag=bottom
...
implant phosphorus energy=40 dose=5.0e15
etch poly left p1.x=0.8
etch poly start x=1.2 y=0.5
etch continue x=2.8 y=0.5
etch continue x=2.8 y=-3
etch done x=1.2 y=-3
etch poly right p1.x=3.2
...
deposit oxide thick=0.6
etch oxide start x=-1 y=-0.5
etch continue x=5 y=-0.5
etch continue x=5 y=-2
etch done x=-1 y=-2
...
etch continue x=1.8 y=-2
etch done x=1.5 y=-2
etch oxide start x=2.2 y=0.5
etch continue x=2.5 y=0.5
etch continue x=2.5 y=-2
etch done x=2.2 y=-2
etch oxide start x=2.85 y=-0.1
etch continue x=3.15 y=-0.1
etch continue x=3.15 y=-2
etch done x=2.85 y=-2
etch oxide start x=3.5 y=0.5
etch continue x=3.8 y=0.5
etch continue x=3.8 y=-2
etch done x=3.5 y=-2
